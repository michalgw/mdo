...
uses
  ...
  StdCtrls, ExtCtrls, Buttons, lr_mdodataset, DB;

type

  { TlrMDOEditParamsForm }

  TlrMDOEditParamsForm = class(TForm)
    BitBtn1: TBitBtn;
...
var
  lrMDOEditParamsForm: TlrMDOEditParamsForm;

implementation
uses lr_mdoconst, lr_expres;

{$R *.lfm}

{ TlrMDOEditParamsForm }

procedure TlrMDOEditParamsForm.FormCreate(Sender: TObject);
begin
  Caption:=slrMDOEditParamsForm_Caption;
  GroupBox1.Caption:=slrMDOEditParamsForm_ParamsList;
  GroupBox2.Caption:=slrMDOEditParamsForm_ParamValue;
  Label1.Caption:=slrMDOEditParamsForm_ParamType;
  Label2.Caption:=slrMDOEditParamsForm_ParamValue;
  BitBtn1.Caption:=slrMDOEditParamsForm_SelectExpresion;
  //
  FParams:=TQueryParamList.Create;
end;

procedure TlrMDOEditParamsForm.FormCloseQuery(Sender: TObject;
...
procedure TlrMDOEditParamsForm.BitBtn1Click(Sender: TObject);
var
...
procedure TlrMDOEditParamsForm.FormDestroy(Sender: TObject);
begin
  FreeAndNil(FParams);
end;

procedure TlrMDOEditParamsForm.ListBox1Click(Sender: TObject);
var
  P:TQueryParam;
begin
...
procedure TlrMDOEditParamsForm.LoadParamList(AParams: TQueryParamList);
var
  i:integer;
  P:TQueryParam;
begin
...
procedure TlrMDOEditParamsForm.SaveParamList(AParams: TQueryParamList);
var
  i:integer;
  P, P1:TQueryParam;
begin
